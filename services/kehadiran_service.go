...
func (s *KehadiranService) CreateKehadiran(req *models.CreateKehadiranRequest, securityKode string) error {
	...
	// Jika kehadiran = HADIR, update status peminjaman menjadi ONGOING
	if req.StatusKehadiran == models.KehadiranHadir {
		if err := s.PeminjamanRepo.UpdateStatusOnly(req.KodePeminjaman, models.StatusPeminjamanOngoing); err != nil {
			return err
		}
	}
